public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task newTask = new Task("task one", "updated description of task one", task.getId(),TaskStatus.IN_PROGRESS);
        ...
        System.out.println("Добавим сабтасков");
        SubTask subTask = new SubTask("subtask 1","description 1",0, TaskStatus.NEW, newEpic);
        manager.createSubTask(subTask);
        SubTask subTask2 = new SubTask("subtask 2","description 2",0, TaskStatus.IN_PROGRESS, newEpic);
        ...
        SubTask newSubTask = new SubTask("subtask 1","updated description 1",subTask.getId(), TaskStatus.DONE, newEpic);
        manager.updateSubTask(newSubTask);
        SubTask newSubTask2 = new SubTask("subtask 2","updated description 2",subTask2.getId(), TaskStatus.DONE, newEpic);
